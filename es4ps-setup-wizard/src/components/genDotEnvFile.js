/*
 *
 * A core function of the platform, this module splits the generation of the
 * .env file into three sections: RabbitMQ, Samba, and Django. Each section
 * is generated by its respective function, and the final .env file is created
 * through the genDotEnvFile function which concatenates the three sections.
 *
 * These are generated by all parameters that the user has inputted in the
...
// in Django deploy recomendations it is stated that the secret key should be
// a random string to ensure security of the application. This function generates
// secret keys that are 256 characters long by default or any other length
// specified by who calls it.
...
// only one function is exposed to the outside world
// in this release, but this will change in the future
// when selection between multiple configurations module
// will be implemented.
